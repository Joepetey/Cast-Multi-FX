...
*/
CDelayPorjectMAC::CDelayPorjectMAC()
{
...
*/
CDelayPorjectMAC::~CDelayPorjectMAC(void)
{
...
*/
bool __stdcall CDelayPorjectMAC::initialize()
{
	// Add your code here
...
processRackAFXMessage()
	...
	See the website www.willpirkle.com for more details
*/
void __stdcall CDelayPorjectMAC::processRackAFXMessage(UINT uMessage, PROCESS_INFO& processInfo)
{
...
*/
bool __stdcall CModDelayIt::prepareForPlay()
{
	// --- init the LFO
	lfo.setSampleRate((float)m_nSampleRate);
	lfo.setOscFrequency(m_fRate); // --- init value
	lfo.setOscWaveform(m_uLFOWaveForm); // --- init value
	lfo.reset();
...
// --- notice how similar this is to the Envelope Follower code?
float CModDelayIt::calculateModDelayTime_mSec(float modValue)
{
...
//     4) deliver delayed output sample
//
float CModDelayIt::doNormalDelay(float xn, float delay_mSec, float feedback, UINT channel)
{
...
*/
bool __stdcall CModDelayIt::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
...
//
bool __stdcall CDelayPorjectMAC::userInterfaceChange(int nControlIndex)
{
...
bool __stdcall CDelayPorjectMAC::checkUpdateGUI(int nControlIndex, float fValue, CLinkedList<GUI_PARAMETER>& guiParameters, bool bLoadingPreset)
{
...
bool __stdcall CDelayPorjectMAC::processAuxInputBus(audioProcessData* pAudioProcessData)
{
...
*/
bool __stdcall CDelayPorjectMAC::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
/* processAudioBuffer
	...
	******************************
	...
	m_HostProcessInfo.uTimeSigDenomintor = Host Time Signature Denominator (if supported by host)
*/
bool __stdcall CDelayPorjectMAC::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CDelayPorjectMAC::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CDelayPorjectMAC::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CDelayPorjectMAC::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CDelayPorjectMAC::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CDelayPorjectMAC::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CDelayPorjectMAC::midiClock()
{
...
bool __stdcall CDelayPorjectMAC::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
*/
void CDelayPorjectMAC::doVSTSampleAccurateParamUpdates()
{
...
void* __stdcall CDelayPorjectMAC::showGUI(void* pInfo)
{
...
bool __stdcall CDelayPorjectMAC::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! -------------------------------------- //
...
// **--0xDEA7--**
	...
	ui1->m_pUserCookedFloatData = &m_fDepth_pct;
	ui1->m_pUserCookedDoubleData = NULL;
	ui1->m_pUserCookedUINTData = NULL;
	ui1->cControlUnits = "%";
	ui1->cVariableName = "m_fDepth_pct";
	...
	ui3->fUserDisplayDataHiLimit = 200.000000;
	...
	ui4->fUserDisplayDataLoLimit = -100.000000;
	ui4->fUserDisplayDataHiLimit = 0.000000;
	...
	ui6->fUserDisplayDataHiLimit = 3.000000;
	...
	ui6->m_pUserCookedUINTData = &m_uLFOWaveForm;
	ui6->cControlUnits = "";
	ui6->cVariableName = "m_uLFOWaveForm";
	ui6->cEnumeratedList = "TRI,SINE,UPSAW,DNSAW";
	...
	ui7->m_pUserCookedUINTData = &m_uMode;
	ui7->cControlUnits = "";
	ui7->cVariableName = "m_uMode";
	ui7->cEnumeratedList = "FLANGER,VIBRATO,CHORUS";
	...
	ui8->m_pUserCookedUINTData = &m_uLFOPhase;
	ui8->cControlUnits = "";
	ui8->cVariableName = "m_uLFOPhase";
	ui8->cEnumeratedList = "NORM,QUAD";
